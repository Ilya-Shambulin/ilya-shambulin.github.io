...
`,children:"Связаться"}),e.jsx(p,{code:`<style>
...
<\/script>`,className:"w-html-embed c1mxnpsi"})]}),e.jsx(p,{code:`<style>
...
<\/script>`,className:"w-html-embed"}),e.jsx(p,{code:`<script>
document.addEventListener("DOMContentLoaded", () => {
...
<\/script>`,className:"w-html-embed"}),e.jsx(p,{code:`
