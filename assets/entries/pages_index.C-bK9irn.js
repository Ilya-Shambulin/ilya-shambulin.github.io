import{r as m,a as B,R as q,j as e,b as g,i as M,P as D,c as O,d as H}from"../chunks/chunk-Ckdsfueu.js";/* empty css                      */var U=(c,t)=>/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i.test(c)===!1&&(t!==""&&c.startsWith("/")&&c.startsWith(t))===!1,F=(c,t,n)=>c===""?{pathname:t.pathname,search:t.search,hash:""}:c.startsWith("#")?{pathname:t.pathname,search:t.search,hash:c==="#"?"":c}:n,W=(c,t)=>c.pathname===t.pathname&&c.search===t.search&&c.hash===t.hash;const V=(c,t,n)=>{const{href:i,"aria-current":a,className:s,...r}=c,o=F(i,t,n),d=W(t,o),p=[s,d?"active":void 0].filter(Boolean).join(" ");return{linkProps:r,currentLinkProps:{...d?{"aria-current":a??"page"}:{},...p===""?{}:{className:p}}}},E=({prefetch:c,discover:t,reloadDocument:n,replace:i,preventScrollReset:a,relative:s,state:r,viewTransition:o,...d})=>d,Q=()=>{if(!(typeof window>"u"))return window.location.href},X=c=>{if(c!==void 0)return new URL(c,"https://webstudio.local")},l=m.forwardRef((c,t)=>{const n=m.useContext(B),{assetBaseUrl:i}=m.useContext(q),{children:a,$webstudio$canvasOnly$assetId:s,"aria-current":r,className:o,...d}=c,p=d.href!==void 0,h=p?String(d.href):"#",N=n??Q(),y=X(N);let w=E(d),k={...r===void 0?{}:{"aria-current":r},...o===void 0?{}:{className:o}};if(y&&p&&U(h,i)){const b=V({...d,href:h,"aria-current":r,className:o},y,new URL(h,y));w=E(b.linkProps),k=b.currentLinkProps}return e.jsx("a",{...w,...k,href:h===""&&y?`${y.pathname}${y.search}`:h,ref:t,children:a})});l.displayName="Link";function Y(...c){return c.length===1&&c[0]?c[0]:t=>{for(let n of c)typeof n=="function"?n(t):n!=null&&(n.current=t)}}const G=()=>document.readyState==="complete"||document.readyState==="interactive",v=[];let I=!1;const Z=()=>{if(G()===!1){console.error("DOMContentLoaded event has not been fired yet");return}if(I)return;I=!0;const c=document.addEventListener,t=window.addEventListener,n=new Event("DOMContentLoaded"),i=new Event("load");window.addEventListener=(a,s,r)=>{a==="DOMContentLoaded"?v.push(()=>s.call(window,n)):(a==="load"&&v.push(()=>s.call(window,i)),t.call(window,a,s,r))},document.addEventListener=(a,s,r)=>{a==="DOMContentLoaded"?v.push(()=>s.call(document,n)):c.call(document,a,s,r)}},K=()=>{for(const c of v)c();v.length=0},J="client-",ee=c=>new Promise((t,n)=>{const i=document.createElement("script"),a=c.hasAttribute("src"),s=c.type==="module";for(const{name:r,value:o}of c.attributes)i.setAttribute(r,o);if(i.dataset.testid!==void 0&&(i.dataset.testid=`${J}${i.dataset.testid}`),a)i.addEventListener("load",()=>{t()}),i.addEventListener("error",n);else{if(s){const r=new Blob([c.innerText],{type:"text/javascript"}),o=URL.createObjectURL(r);import(o).then(t).catch(n).finally(()=>{URL.revokeObjectURL(o)});return}i.textContent=c.innerText}c.replaceWith(i),a===!1&&t()}),z=[];let S=!1;const ce=async c=>{if(z.push(...c),await Promise.resolve(),!S){for(Z(),S=!0;z.length>0;)await z.shift()();K(),S=!1}},te=c=>{const t=c.querySelectorAll("script"),n=[],i=[];t.forEach(a=>{(a.hasAttribute("async")?i:n).push(()=>ee(a))});for(const a of i)a();ce(n)},ne=c=>{const{code:t,innerRef:n,...i}=c;return e.jsx("div",{ref:n,...i,style:{display:"block",padding:20},children:'Open the "Settings" panel to insert HTML code.'})},_=()=>m.useSyncExternalStore(()=>()=>{},()=>!1,()=>!0),j=c=>{if(!_())return c.children},T=c=>{const{code:t,innerRef:n,...i}=c,a=m.useRef(null),s=m.useRef(!0),r=m.useMemo(()=>({__html:t??""}),[t]);return m.useEffect(()=>{const o=a.current;o&&s.current&&(s.current=!1,te(o))},[]),e.jsx("div",{...i,ref:Y(n,a),dangerouslySetInnerHTML:r})},P=c=>{const{code:t,innerRef:n,...i}=c;return e.jsx("div",{...i,ref:n,dangerouslySetInnerHTML:{__html:t??""}})},A=P,f=m.forwardRef((c,t)=>{const{code:n,executeScriptOnCanvas:i,clientOnly:a,children:s,...r}=c,{renderer:o,isSafeMode:d}=m.useContext(q),p=_(),[h]=m.useState(p);return n===void 0||String(n).trim().length===0?e.jsx(ne,{innerRef:t,...r}):h?a!==!0?e.jsx(P,{innerRef:t,code:n,...r}):e.jsx(j,{children:e.jsx(T,{innerRef:t,code:n,...r})}):d?e.jsx(j,{children:e.jsx(A,{innerRef:t,code:n,...r})}):o==="canvas"&&i!==!0?e.jsx(j,{children:e.jsx(A,{innerRef:t,code:n,...r})}):e.jsx(j,{children:e.jsx(T,{innerRef:t,code:n,...r},n)})});f.displayName="HtmlEmbed";var ie=`data:image/svg+xml;base64,${btoa(`<svg
  width="140"
  height="140"
  viewBox="0 0 600 600"
  fill="none"
  ...
  <path
    ...
    fill="#C1C8CD"
  />
</svg>`)}`,ae=[16,32,48,64,96,128,256,384],L=[640,750,828,1080,1200,1920,2048,3840],u=[...ae,...L],se=(c,t)=>{if(t){const a=/(^|\s)(1?\d?\d)vw/g,s=[];for(let r;r=a.exec(t);r)s.push(Number.parseInt(r[2],10));if(s.length){const r=Math.min(...s)*.01;return{widths:u.filter(o=>o>=L[0]*r),kind:"w"}}return{widths:u,kind:"w"}}if(c==null)return{widths:L,kind:"w"};const n=2;let i=u.findIndex(a=>a>=n*c);return i=i<0?u.length:i,{widths:u.slice(0,i+1),kind:"w"}},re=({src:c,width:t,quality:n,sizes:i,loader:a})=>{const{widths:s,kind:r}=se(t,i);return{sizes:!i&&r==="w"?"100vw":i,srcSet:s.map((o,d)=>`${a({src:c,quality:n,width:o})} ${r==="w"?o:d+1}${r}`).join(", "),src:a({src:c,quality:n,width:s[s.length-1]})}},R=c=>{if(typeof c=="number")return Math.round(c);if(typeof c=="string"){const t=Number.parseFloat(c);if(!Number.isNaN(t))return Math.round(t)}},oe="(min-width: 1280px) 50vw, 100vw",le=80,de=c=>{try{return new URL(c),!0}catch{return!1}},me=c=>{const t=R(c.width),n=Math.max(Math.min(R(c.quality)??le,100),0);if(c.src!=null&&c.src!==""){if(c.src.startsWith("data:"))return{src:c.src};if(c.srcSet==null&&c.optimize){const a=c.sizes??(c.width==null?oe:void 0);return re({src:c.src,width:t,quality:n,sizes:a,loader:c.loader})}const i={src:de(c.src)?c.src:c.loader({src:c.src,format:"raw"})};return c.srcSet!=null&&(i.srcSet=c.srcSet),c.sizes!=null&&(i.sizes=c.sizes),i}},pe=({quality:c,loader:t,optimize:n=!0,loading:i="lazy",decoding:a="async",...s})=>{const r=me({src:s.src,srcSet:s.srcSet,sizes:s.sizes,width:s.width,quality:c,loader:t,optimize:n})??{src:ie};return{alt:"",...s.alt!==void 0?{alt:s.alt}:{},...s.width!==void 0?{width:s.width}:{},...s.height!==void 0?{height:s.height}:{},...r,decoding:a,loading:i}};const he=({props:c,imageLoader:t,renderer:n})=>{let{loading:i="lazy",width:a,height:s,optimize:r=!0,decoding:o,quality:d,$webstudio$canvasOnly$assetId:p,alt:h,sizes:N,srcSet:y,src:w,...k}=c;const b=String(w??"");let C=b;return n==="canvas"&&(i="eager",o="sync",C=p??b,a!==void 0&&s!==void 0&&Number.isNaN(a)&&Number.isNaN(s)&&(r=!1,a=void 0,s=void 0)),{key:C,imageProps:{...k,...pe({alt:h,width:a,height:s,sizes:N,src:b,srcSet:y,quality:d,loader:t,optimize:r,loading:i,decoding:o})}}},x=m.forwardRef((c,t)=>{const{imageLoader:n,renderer:i}=m.useContext(q),{key:a,imageProps:s}=he({props:c,imageLoader:n,renderer:i});return e.jsx("img",{...s,ref:t},a)});x.displayName="Image";const $=void 0,fe=[{id:"cRYmr86dmRW_vp3SlcTMq"},{id:"lamraCdNr6x864fZW4-71",maxWidth:790}],ye="avatar_wD6Rh8InQc6aRE7RC56OQ.png",xe=["classicrussian_bolditalic_9OGPqjnCWGj2nlQ7H7Hf0.ttf","classicrussian_zdp5-O2AtRqAIZSBXaFfG.ttf","VelaSans-GX_v_5DtQOWyEVeM3bXiqVU8.ttf","classicrussianplain_XXMua8U76VDK3aVS9K5cd.ttf","classicrussian_bold_OxcgvGtvwvAwzeBKwHShq.ttf","VelaSans-Light_0sa8UXgQ8-6hzxlTDA9-d.ttf","classicrussianbolditalic_Dx6Uvg1MAPd5I9fWqqbDJ.ttf","VelaSans-Regular_l1R7RQq8PDNvC935XG6EB.ttf","classicrussian_italic_DydJDyeVNhB8pcziGelwg.ttf","classicrussianitalic_Ve7pfI9u21nFBPocc-GYI.ttf","classicrussianbold_EVyQkBmEr1aB2T3vLyeCJ.ttf"],be=[],ue=c=>e.jsxs("body",{className:"w-element cbgfy19 c1ghyfie cktccy8 c15im3zh cidopjm c1t1ky9i cjgug1y c10upm9x crtfhpm",children:[e.jsxs("div",{className:"w-element c5ud6dt ctrqbiw c1uj8myn c1bdxy3n c1f6vrps c11f31e3 c1hbfygp c1axp7bz c1hwq8cc c1t1ky9i c18hk7wt cs6kyoq cjgug1y c1aqv6us cvolzx7 c1bss3jj c1npjhdx c1w0f9rl c1ijy4jg crjcrep ck8szcj",children:[e.jsx("div",{id:"intro",className:"w-element c1dt4toh c1t1ky9i c9y978x c14sb83n c5ud6dt c11f31e3 ctdclm5 c15s627d c1hwq8cc ckl92cv cyvmqhh cgdvsya ci6t33 c1ijy4jg crjcrep",children:e.jsxs("div",{className:"w-element c1t1ky9i c12jobch cn43n1h c1ss0qyd c1bf3gbv cbzgvrn cjgug1y c18tpnkd cs6kyoq c1ghyfie c1y3tvcb ctdclm5 c1lmqsq8 c11f31e3 cseikrj cq6vf2n cknnh12 cbgt5od cnpmm9y crtfhpm reveal-group",children:[e.jsxs("div",{className:"w-element c1t1ky9i c12jobch cn43n1h c1ss0qyd c1bf3gbv c12z4sws cjgug1y cbgt5od c12pndbt cja3lwc",children:[e.jsxs("div",{"data-reveal":"",className:"w-element chqwizw cttdk6k c1t1ky9i c1sesscl c9y978x cs6kyoq cf9kvnj c93layf c9uu1mj c1ghyfie cv9ty0f cefdn9z c9e82x3 ckvhfsb",children:[e.jsx("div",{className:"w-element ctyqyhg c8lis7b c11f31e3 c1vg1ldp crzsn58",children:e.jsx(x,{src:"/assets/avatar_wD6Rh8InQc6aRE7RC56OQ.png",width:80,height:80,alt:"Анфас дизайнера",className:"w-image avatar"})}),e.jsxs("h3",{className:"w-element cbgfy19 c13hwq9p c1yboeqv cfky18h cje2fxc clako7o c5bqngv cee4xb8",children:["Илья Шамбулин","",e.jsx("br",{}),"",e.jsx("span",{className:"w-element",children:"Продуктовый дизайнер"})]})]}),e.jsxs("h1",{"data-reveal":"",className:"w-element cieqqcu c1u5offw clako7o c1vrp7pb c5bqngv c1am9md2 cpllduj c1i78djw c11isikc",children:[e.jsxs("span",{className:"w-element cwnd9p8 c1vrp7pb c11isikc c1vom59",children:["Делаю сложные интерфейсы, ","",e.jsx("br",{}),"","в которых легко быть человеком "]}),e.jsx(f,{code:`
...
`,executeScriptOnCanvas:!1,className:"w-html-embed czmkkbm cyevpe8 cnudor3 c1mxnpsi"})]}),e.jsx("h3",{className:"w-element cfky18h c15tuz05 c13hwq9p c1ssdpzc cje2fxc clako7o cbgfy19 c5bqngv ch04zb6 c1bealef cclut8i cu8pon3 cee4xb8",children:"Открыт к предложениям"})]})]})]})}),e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y cjbidmg c1bf3gbv",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c1g7k7ti cdqfwys c1u5offw c124mwf6",children:[e.jsxs("div",{id:"works",className:"w-element cbgt5od c1t1ky9i c1r0i6f5 c11l58ng cxw5uam cmdfsav",children:[e.jsxs("div",{className:"w-element c1j8iybi c1t1ky9i cjgug1y cwh5kk cyhpsl7",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c6p55kh c5uqp3h c1ykdc61",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c1bblol2 coo2v9f",children:[e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i c1sesscl coo2v9f c1bblol2",children:[e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"rTIM"}),e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"|"}),e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"10 минут на чтение"})]}),e.jsx("h2",{"data-reveal":"",className:"w-element chydk8c c1u5offw clako7o c1vrp7pb c5bqngv c1j8iybi c1qi3ah2 c13hwq9p c1e37voh c1n6thg7 c126mgj0 ctjol56 c1r42fpw",children:"Дизайн-система, помогающая строить наши города"})]}),e.jsx("p",{"data-reveal":"",className:"w-element c5bqngv cfky18h c14yn3m5 cje2fxc clako7o",children:"Создание и ведение дизайн-системы из сотни компонентов, экранов и цветов для AI-powered проектировочного сервиса на основе данных картографии"})]}),e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i cjgug1y cdlt2zp cf9kvnj",children:[e.jsx(l,{type:"button",href:"https://www.google.com/",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 cic10qx c1i0y4jr c1o1oanr c1vxr82e c1nw50m c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1uspl8d",children:e.jsxs("span",{className:"w-element cbgfy19 cjmqefl c5bqngv cfky18h c1xb78yf",children:["Прочитать ",e.jsx("span",{className:"w-element c16kw8ic",children:"( ಠ ͜ʖರೃ)"})]})}),e.jsxs("div",{className:"w-element c1t1ky9i coo2v9f c1bblol2",children:[e.jsx(l,{type:"button",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"B2B"})}),e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsxs("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:["Desktop",e.jsx("br",{}),""]})}),e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"Проектировочное ПО"})})]})]})]}),e.jsx(f,{code:'<iframe src="https://kinescope.io/embed/cRDgfb3jn4EdhQTpLdnEGq" allow="autoplay; fullscreen; picture-in-picture; encrypted-media; gyroscope; accelerometer; clipboard-write; screen-wake-lock;" frameborder="0" allowfullscreen width="360" height="360"></iframe>',"data-reveal":"",className:"w-html-embed c9uu1mj c1ghyfie c1xx4jjy c1plx3me c3gpemq c1nzigw9 cejj1yn c1bdxy3n ccsx6tw cpiyym7 cm3aiw2 c1e341c9"})]}),e.jsxs("div",{id:"works",className:"w-element cbgt5od c1t1ky9i c1r0i6f5 c11l58ng cxw5uam",children:[e.jsxs("div",{className:"w-element c1j8iybi c1t1ky9i cjgug1y cwh5kk cyhpsl7",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c6p55kh c5uqp3h c1ykdc61",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c1bblol2 coo2v9f",children:[e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i c1sesscl coo2v9f c1bblol2",children:[e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"QuantCAD"}),e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"|"}),e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"10 минут на чтение"})]}),e.jsxs("h2",{"data-reveal":"",className:"w-element chydk8c c1u5offw clako7o c1vrp7pb c5bqngv c1j8iybi c1qi3ah2 c13hwq9p c1e37voh c1n6thg7 c126mgj0 ctjol56 c1r42fpw",children:["112 млн ",e.jsx("span",{className:"w-element chqwizw cxl7cjc cw3msh",children:"₽"})," инвестиций ","",e.jsx("br",{}),"","и ноль редизайнов"]})]}),e.jsxs("p",{"data-reveal":"",className:"w-element c5bqngv cfky18h c14yn3m5 cje2fxc clako7o",children:["Поиск и разработка оптимальных решений ","",e.jsx("br",{}),"","для успешного запуска MVP фотонного САПР, который не пришлось переделывать благодаря масштабируемой дизайн-системе"]})]}),e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i cjgug1y cdlt2zp cf9kvnj",children:[e.jsx(l,{type:"button",href:"https://www.google.com/",className:"w-element chqwizw c16kw8ic cttdk6k c15tuz05 cic10qx c1i0y4jr c1o1oanr c1vxr82e c1nw50m c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1uspl8d",children:e.jsxs("span",{className:"w-element cbgfy19 cjmqefl c5bqngv cfky18h c1xb78yf",children:["Прочитать ",e.jsx("span",{className:"w-element c16kw8ic",children:"( ˘ ³˘)目"})]})}),e.jsxs("div",{className:"w-element c1t1ky9i coo2v9f c1bblol2",children:[e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"B2S"})}),e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsxs("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:["Desktop",e.jsx("br",{}),""]})}),e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"Проектировочное ПО"})})]})]})]}),e.jsx(f,{code:`<div style="width: 360px; height: 360px; overflow: hidden; position: relative; border-radius: 16px; transform: translateZ(0); -webkit-mask-image: -webkit-radial-gradient(white, black);">
...
</div>`,"data-reveal":"",className:"w-html-embed c9uu1mj c1ghyfie c1xx4jjy c1plx3me c3gpemq c1nzigw9 cejj1yn c1bdxy3n ccsx6tw cpiyym7 cm3aiw2 c1e341c9"})]}),e.jsxs("div",{id:"works",className:"w-element cbgt5od c1t1ky9i c1r0i6f5 c11l58ng cxw5uam",children:[e.jsxs("div",{className:"w-element c1j8iybi c1t1ky9i cjgug1y c1knwxb8 c1ca2x0x",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c6p55kh c5uqp3h c1ykdc61",children:[e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c1bblol2 coo2v9f",children:[e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i c1sesscl coo2v9f c1bblol2",children:[e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"Градус тепла"}),e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"|"}),e.jsx("h3",{className:"w-element c5bqngv cfky18h c7ydmfi cje2fxc clako7o",children:"5 минут на чтение"})]}),e.jsx("h2",{"data-reveal":"",className:"w-element chydk8c c1u5offw clako7o c1vrp7pb c5bqngv c1j8iybi c1qi3ah2 c13hwq9p c1e37voh c1n6thg7 c126mgj0 ctjol56 c1r42fpw",children:"Продажа инженерных систем без менеджера"})]}),e.jsxs("p",{"data-reveal":"",className:"w-element c5bqngv cfky18h c14yn3m5 cje2fxc clako7o",children:["Снятие страхов клиентов через контент ","",e.jsx("br",{}),"","и логику сайта на тильде в сфере водоснабжения, отопления и электрики"]})]}),e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i cjgug1y cdlt2zp cf9kvnj",children:[e.jsx(l,{type:"button",href:"https://www.google.com/",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 cic10qx c1i0y4jr c1o1oanr c1vxr82e c1nw50m c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1uspl8d",children:e.jsxs("span",{className:"w-element cbgfy19 cjmqefl c5bqngv cfky18h c1xb78yf",children:["Прочитать ",e.jsx("span",{className:"w-element c16kw8ic",children:"(╭ರ_•́)"})]})}),e.jsxs("div",{className:"w-element c1t1ky9i coo2v9f c1bblol2",children:[e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"B2С"})}),e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"Web"})}),e.jsx(l,{type:"button",href:"",className:"w-element chqwizw c1dbhjn4 cttdk6k c15tuz05 c1qrm8ng c1i0y4jr c1o1oanr cl68b6d c4eebdq c11o1rsj c1dtxm8y c1ffxkx7 c75s3ps ciuyspz cw7re8b c1t1ky9i c9y978x c1h3h4ca coo2v9f c1bblol2 crkq6wa clbpz92 c3ntk31 c4ea4e6 cnpmm9y c9uu1mj c1ibe1yk c1n18ztd",children:e.jsx("span",{className:"w-element cbgfy19 cjmqefl c5bqngv c1ykdc61 c7ydmfi",children:"Лендинг"})})]})]})]}),e.jsx(x,{src:"/assets/Frame_952_1_WnhbWSJFHj14ubNz9wNwG.png",width:1080,"data-reveal":"",className:"w-image cutvrtt cxw5uam cqho5js c2f9ju c1rjy4ay c1fwvg4j"})]})]}),e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c1aqv6us cvolzx7 cbgt5od",children:[e.jsxs("div",{className:"w-element cpiyym7 c12jobch cn43n1h c1ss0qyd c1bf3gbv cbzgvrn cjgug1y c18tpnkd cs6kyoq c1ghyfie c1y3tvcb ctdclm5 c1lmqsq8 c11f31e3 cseikrj cq6vf2n cknnh12 cbgt5od cnpmm9y reveal-group",children:[e.jsx(x,{src:"/assets/Dieter_maqpcP_tNIBJlBxB4Qn7j.png",width:840,height:1297,alt:"",id:"values","data-reveal":"",className:"w-image c118z8uz czmkkbm c130qndo c1i9caxv cmdfsav"}),e.jsxs("div",{className:"w-element c1t1ky9i c12jobch cn43n1h c1ss0qyd c1bf3gbv cdtgyqe cjgug1y cbgt5od",children:[e.jsx("h1",{"data-reveal":"",className:"w-element cieqqcu c1u5offw clako7o c1vrp7pb c5bqngv c1am9md2 cpllduj c1i78djw",children:e.jsx("span",{className:"w-element cwnd9p8 c1vrp7pb",children:"Меньше, но лучше"})}),e.jsx("h1",{"data-reveal":"",className:"w-element cieqqcu c1u5offw clako7o c1vrp7pb c5bqngv c1am9md2 cpllduj c1i78djw c6t2nsr",children:e.jsx("span",{className:"w-element cwnd9p8 c1vrp7pb c7ydmfi c11f31e3",children:"Less but better"})})]})]}),e.jsxs("div",{className:"w-element clkz3ry c12jobch c1rympy0 c1ss0qyd c1bulgx4 coft08o c1ghyfie cbgt5od c18tpnkd cs6kyoq c12qkanr cq35n2q cn84w8l",children:[e.jsxs("p",{"data-reveal":"",className:"w-element cfky18h c1am9md2 c1753p6u cpfk4kc c1iy9oo1 c1d8lgv3 c2442mf c76l1yu",children:["В своей работе я придерживаюсь принципов дизайна, которые сформулировал Дитер. Я считаю, что они применимы не только ","",e.jsx("br",{}),"","к объектам промышленного дизайна, но и к цифровым сервисам.","",e.jsx("br",{}),"","",e.jsx("br",{}),"","Хороший дизайн должен быть честен к себе и к пользователю, должен строиться с учётом ресурсов, которыми мы обладаем."]}),e.jsxs("p",{"data-reveal":"",className:"w-element cfky18h c1am9md2 c2442mf",children:["Ядро философии Дитера — оптимальный для решения пользовательских задач минимализм.","",e.jsx("br",{}),"","",e.jsx("br",{}),"",e.jsx("b",{className:"w-element",children:"Моя задача — искать оптимальное решение на стыке потребностей пользователей, целей компании и ограничений команды."})]})]})]})]}),e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y czl8c44 c6p55kh c5uqp3h c18tpnkd c1h3h4ca c1bdxy3n chrz30a reveal-group",children:[e.jsx("h1",{"data-reveal":"",id:"contact",className:"w-element cieqqcu c1u5offw clako7o c1vrp7pb c5bqngv cbgt5od cpllduj c1i78djw c1t1ky9i cjgug1y cdlt2zp cf9kvnj c1ghyfie c18tpnkd c1h3h4ca c1wz28sq",children:e.jsx("span",{"data-reveal":"",className:"w-element cwnd9p8 c1vrp7pb cbgt5od cvqwz5o cic10qx typewriter-morse",children:"Будем на связи"})}),e.jsxs("div",{className:"w-element c1t1ky9i cjgug1y c1bblol2 coo2v9f",children:[e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i c9y978x cs6kyoq coo2v9f c1bblol2 cfky18h",children:[e.jsx(x,{src:"/assets/tg_black_UMqRFE3bOfBt2wZt4HQ1Q.svg",width:24,height:24,alt:"",className:"w-image cbo0a7t"}),e.jsx(l,{href:"https://t.me/IlyaShamb",className:"w-element c13to7nf cfky18h c15tuz05 c1vcftj7 c1xb78yf cbgfy19 c1ioryru",children:"Telegram: @IlyaShamb"})]}),e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i c9y978x cs6kyoq coo2v9f c1bblol2",children:[e.jsx(x,{src:"/assets/Pin_PMqRZ83VWm5uBT3v-6RJE.svg",width:28,height:28,alt:"",className:"w-image cbo0a7t"}),e.jsxs("h2",{"data-reveal":"",className:"w-element cfky18h c1u5offw clako7o cbgfy19 c5bqngv cgxs7b2 c15tuz05 c13hwq9p c1e37voh c1n6thg7 c126mgj0 ctjol56 c1r42fpw",children:["Санкт-Петербург ",e.jsx("span",{className:"w-element c7ydmfi",children:"(без релокации)"})]})]}),e.jsxs("div",{"data-reveal":"",className:"w-element c1t1ky9i c9y978x cs6kyoq coo2v9f c1bblol2",children:[e.jsx(x,{src:"/assets/mail_sX_tTpvUK3BjEj_cG_KR2.svg",width:28,height:28,alt:"",className:"w-image cbo0a7t"}),e.jsx(f,{code:`<div class="email-widget">
...
<\/script>`,className:"w-html-embed c15tuz05 cfky18h c1vcftj7 cbgfy19"})]})]})]}),e.jsxs("div",{className:`w-element c1vs0y4n c1jtgw1l c1a3xdoe c1t1ky9i cjgug1y c1bblol2 coo2v9f ctdclm5 c17ed0gl c9uu1mj crccz8s c1ghyfie menu-sidebar
...
`,children:"Связаться"}),e.jsx(f,{code:`<style>
...
<\/script>`,className:"w-html-embed c1mxnpsi"})]}),e.jsx(f,{code:`<script>
document.addEventListener("DOMContentLoaded", () => {
...
<\/script>`,className:"w-html-embed"}),e.jsx(f,{code:`
...
`,className:"w-html-embed"})]}),e.jsx("div",{className:"w-element c1t1ky9i cjgug1y czl8c44 c6p55kh c5uqp3h c9y978x c1h3h4ca c1bdxy3n c10lyvrj c8h4jae c8hpzfi ",children:e.jsxs("h2",{className:"w-element cfky18h c1u5offw clako7o cbgfy19 c5bqngv c1am9md2 c15tuz05 c13hwq9p c1e37voh c1n6thg7 c126mgj0 ctjol56 c1r42fpw c7ydmfi",children:[e.jsx("b",{className:"w-element",children:e.jsx("i",{className:"w-element",children:"❤"})}),"   сделано с любовью | Илья Шамбулин | 59.938°, 30.315°"]})})]}),ge=c=>{const{origin:t,pathname:n,search:i}=new URL(c);return`${t}${n}${i}`},ve=m.memo(({pageKey:c,system:t})=>e.jsx(ue,{system:t},c),(c,t)=>c.pageKey===t.pageKey),we=({data:c})=>{const{system:t,resources:n,url:i,pageMeta:a}=c,s=ge(i),r=m.useMemo(()=>({imageLoader:M,assetBaseUrl:g,resources:n,breakpoints:fe,onError:console.error}),[n]);return e.jsxs(q.Provider,{value:r,children:[e.jsx(B.Provider,{value:i,children:e.jsx(ve,{pageKey:s,system:t})}),e.jsx(D,{url:i,pageMeta:a,siteName:$,imageLoader:M,assetBaseUrl:g}),e.jsx(O,{children:a.title})]})},ke=Object.freeze(Object.defineProperty({__proto__:null,default:we},Symbol.toStringTag,{value:"Module"})),je=({})=>e.jsxs(e.Fragment,{children:[$,e.jsx("link",{rel:"icon",href:M({src:`${g}${ye}`})}),xe.map(c=>e.jsx("link",{rel:"preload",href:`${g}${c}`,as:"font",crossOrigin:"anonymous"},c)),be.map(c=>e.jsx("link",{rel:"preload",href:`${g}${c}`,as:"image"},c))]}),qe=Object.freeze(Object.defineProperty({__proto__:null,Head:je},Symbol.toStringTag,{value:"Module"})),Se={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:{server:!0}}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"/renderer/+onRenderClient.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:H}},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/index/+Page.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:ke}},Head:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/index/+Head.tsx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:qe}}};export{Se as configValuesSerialized};
